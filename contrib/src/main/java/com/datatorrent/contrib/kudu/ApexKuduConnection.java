...
/**
 * Represents a connection to the Kudu cluster. An instance of this class is to be supplied (via a builder pattern to)
 * {@link AbstractKuduOutputOperator} to connect to a Kudu cluster.
 */
...
public class ApexKuduConnection implements AutoCloseable, Serializable
{
  ...
  Logger LOG = LoggerFactory.getLogger(ApexKuduConnection.class);
