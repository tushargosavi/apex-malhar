...
public class KuduCreateUpdateDeleteOutputOperatorTest
{
  ...
  private SimpleKuduOutputOperator simpleKuduOutputOperator;

  private OperatorContextTestHelper.TestIdOperatorContext contextForKuduOutputOperator;
  ...
  public void setUpKuduOutputOperatorContext() throws Exception
  {
    ...
    contextForKuduOutputOperator = new OperatorContextTestHelper.TestIdOperatorContext(OPERATOR_ID_FOR_KUDU_CRUD,
        attributeMap);
    simpleKuduOutputOperator = new SimpleKuduOutputOperator();
